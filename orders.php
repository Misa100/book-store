...
<section class="placed-orders">
   ...
   <h1 class="title">placez une commande</h1>
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> emplacement : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         ...
         <p> prix total : <span><?php echo $fetch_orders['total_price']; ?> /Ar</span> </p>
         <p> status paiement : <span style="color:<?php if(isset($fetch_orders['payment_status']) && $fetch_orders['payment_status'] == 'pending')
